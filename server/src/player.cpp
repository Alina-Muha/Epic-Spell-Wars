...
//        });
    ...
    int Player::unique_types_in_spell(){
        return static_cast<int>(this->get_achane_num_in_spell() != 0) + static_cast<int>(this->get_dark_num_in_spell() != 0)
                + static_cast<int>(this->get_illusion_num_in_spell() != 0)
                + static_cast<int>(this->get_primal_num_in_spell() != 0) + static_cast<int>(this->get_elemental_num_in_spell() != 0);
    }
