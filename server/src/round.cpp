...
bool compare_two_cards(std::shared_ptr<card::Card> a,
                       std::shared_ptr<card::Card> b) {
  if (a->get_type_of_the_spell_component() ==
  ...
  if (a->get_type_of_the_spell_component() ==
      ...
      b->get_type_of_the_spell_component() ==
          card::Card::type_of_spell_component::delivery) {
    return true;
  }
  if (a->get_type_of_the_spell_component() ==
...
void Round::play_cards(std::shared_ptr<player::Player> gamer) {
  ...
  std::sort(gamer->get_spell().begin(), gamer->get_spell().end(),
            compare_two_cards);
...
QList<QString>
Round::damage_to_chosen_foe(std::shared_ptr<player::Player> &current_player,
                            int sum, int type,
  ...
  players_with_damage.append(
      QString::fromStdString(chosen_foe.get()->get_name()));
  return players_with_damage;
}

QList<QString> Round::damage_to_random_foe(
    std::shared_ptr<player::Player> &current_player, [[maybe_unused]] int sum,
    int type, [[maybe_unused]] std::shared_ptr<player::Player> &chosen_foe) {
  // card Professor Presto's (Source_2.png) and card Mind-Altering
  // (Quality_4.png)
  QList<QString> players_with_damage;
...
QList<QString> Round::hp_to_current_player(
    std::shared_ptr<player::Player> &current_player, int sum, int type,
    [[maybe_unused]] std::shared_ptr<player::Player> &chosen_foe) {
  QList<QString> players_with_damage;
...
QList<QString> Round::damage_for_several_foes(
    std::shared_ptr<player::Player> &current_player, int sum, int type,
    [[maybe_unused]] std::shared_ptr<player::Player> &chosen_foe) {
  QList<QString> players_with_damage;
  ...
  if (type == 5) {
    ...
    if (num != -1) {
      std::shared_ptr<card::Card> delivery_card =
          current_player.get()->get_spell()[num];
...
QList<QString> Round::type_of_cards_damage(
    std::shared_ptr<player::Player> &current_player, [[maybe_unused]] int sum,
    int type, [[maybe_unused]] std::shared_ptr<player::Player> &chosen_foe) {
  QList<QString> players_with_damage;
...
QList<QString> Round::damage_without_parametrs(
    std::shared_ptr<player::Player> &current_player, [[maybe_unused]] int sum,
    int type, [[maybe_unused]] std::shared_ptr<player::Player> &chosen_foe) {
  QList<QString> players_with_damage;
  std::shared_ptr<player::Player> strongest_player =
...
QList<QString> Round::change_spell(
    std::shared_ptr<player::Player> &current_player, [[maybe_unused]] int sum,
    int type, [[maybe_unused]] std::shared_ptr<player::Player> &chosen_foe) {
  QList<QString> players_with_damage;
  int num = get_num_of_player_in_circle(current_player);
...
QList<QString> Round::change_order(
    std::shared_ptr<player::Player> &current_player, [[maybe_unused]] int sum,
    [[maybe_unused]] int type,
    [[maybe_unused]] std::shared_ptr<player::Player> &chosen_foe) {
