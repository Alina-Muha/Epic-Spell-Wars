...
namespace game {
    ...
    private:
        ...
        std::make_shared<card::Card>(card::Card(11, card::Card::type::ahcane,card::Card::type_of_spell_component::delivery, 4)),
        ...
        std::make_shared<card::Card>(card::Card(12, card::Card::type::elemental,card::Card::type_of_spell_component::quality, 0)),
